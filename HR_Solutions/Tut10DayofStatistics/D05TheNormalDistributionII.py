...
# Read the threshold values for the questions
x1 = float(input())
# Read the pass/fail threshold value
x2 = float(input())

# Calculate probabilities
prob_higher_than_80 = 1 - normal_cdf(x1, mean, std_dev)
# Calculate the probability of passing and failing
...
# Print the probability of passing
print(f"{prob_passed * 100:.2f}")
# Print the probability of failing
