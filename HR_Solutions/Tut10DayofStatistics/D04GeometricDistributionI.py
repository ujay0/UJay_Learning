...
# What is the probability that the 1st defect occurs on the 5th item produced?

# Input Format

# The first line contains the respective space-separated numerator and 
# denominator for the probability of a defect, and the second line contains 
...
if __name__ == "__main__":
    ...
    print(f"Probability that the first defect occurs on the {inspection_number}th item: {probability_first_defect_on_kth_item:.3f}")
